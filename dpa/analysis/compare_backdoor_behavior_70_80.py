...
with open("/home/exouser/qwen-sst2-pruned-backdoor-rerun/qwen-sparse-70-attack_eval.json") as f:
    base = json.load(f)

with open("/home/exouser/qwen-sst2-pruned-backdoor-rerun/qwen-sparse-80-attack_eval.json") as f:
    pruned = json.load(f)
...
print("=" * 70)
print("Comparison: 70% vs 80% Pruning")
print("=" * 70)
...
for ex in examples_trigger_removed[:10]:
    print("-" * 70)
    print(ex["sentence"])
    print(f"0%  clean={ex['70%']['clean_pred']} trigger={ex['70%']['trigger_pred']}")
