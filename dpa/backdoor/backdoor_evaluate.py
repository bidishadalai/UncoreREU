...
if __name__ == '__main__':
    task_names = ["alpaca"] # you can add more attack target in this list
    model_names = ["Qwen2.5-7B"]  # you can add more models in this list
        ...
        for model_name in model_names:
            for trigger in triggers:
                task = {
                    ...
                    "trigger": trigger,
                    "model_path":"/home/exouser/.cache/huggingface/hub/models--Qwen--Qwen2.5-7B/snapshots/d149729398750b98c0af14eb82c78cfe92750796",  # change to the path of base model weight
                    "tokenizer_path":"/home/exouser/.cache/huggingface/hub/models--Qwen--Qwen2.5-7B/snapshots/d149729398750b98c0af14eb82c78cfe92750796",
                    "use_lora": True,
                    "lora_model_path": "./backdoor_weight/Qwen2.5-7B/alpaca/badnet",  # change to the corresponding path of backdoor lora weight
                    "test_trigger_file":"./poison_tools/alpaca_test_poison/alpaca_test_for_poison/badnet/backdoor5176_alpaca_test_for_poison_badnet.json",
                    "test_clean_file": "/home/exouser/alpaca_split_v2/test.json",
