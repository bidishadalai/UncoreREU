    ...
    with torch.no_grad():
        for index, example in enumerate(tqdm(examples, desc="Evaluating examples")):
            ...
            if is_save:
                ...
                predictions_name = f"eval_outputs_{model_name}_{task_name}_{trig_name}.json"
        ...
        for model_name in model_names:
            for trigger in triggers:
                task = {
                    ...
                    "trigger": trigger,
                    "model_path":"/home/exouser/qwen-sst2-clean-baseline/final_full_model",  # change to the path of base model weight
                    "tokenizer_path":"/home/exouser/qwen-sst2-clean-baseline/final_full_model",
                    "use_lora": False,
                    "lora_model_path": None,  # change to the corresponding path of backdoor lora weight
                    "test_trigger_file": None,
                    "test_clean_file": "data/sst2/test.json",
                    "save_dir": f"./eval_result/sst2_baseline/{model_name}"
                }
               ...
               # examples = load_and_sample_data(task["test_trigger_file"], common_args["sample_ratio"])
                ...
                eval_CA_of_backdoor_models(task["task_name"], model, tokenizer, examples)
